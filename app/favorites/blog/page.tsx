...
export default function Component() {
    return (
        <div className="flex flex-col gap-10 px-4 py-6">
            <h1 className="text-4xl font-bold">My Favorite Blogs</h1>
            <div className="grid w-full gap-4">
                <Card>
                    <CardHeader>
                        <CardTitle>plantegg 的博客</CardTitle>
                        <CardDescription>学习大佬排查问题的思路.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Link className="text-blue-500 underline" href="https://plantegg.github.io/">
                            Visit Plantegg Blog
                        </Link>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader>
                        <CardTitle>manjusaka 的博客</CardTitle>
                        <CardDescription>看看SRE大佬在学习什么.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Link className="text-blue-500 underline" href="https://www.manjusaka.blog">
                            Visit Manjusaka Blog
                        </Link>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader>
                        <CardTitle>伪架构师的博客</CardTitle>
                        <CardDescription>云原生技术实践.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Link className="text-blue-500 underline" href="https://blog.fleeto.us/">
                            Visit DuSTiSe Blog
                        </Link>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader>
                        <CardTitle>jokerbai 的博客</CardTitle>
                        <CardDescription>jokerbai 的运维开发故事.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Link className="text-blue-500 underline" href="https://www.jokerbai.com/">
                            Visit Jokerbai Blog
                        </Link>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader>
                        <CardTitle>so1n 的博客</CardTitle>
                        <CardDescription>python 实践指引.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Link className="text-blue-500 underline" href="https://so1n.me/">
                            Visit so1n Blog
                        </Link>
                    </CardContent>
                </Card>
            ...
            <div className="flex flex-col gap-4 w-full max-w-md mx-auto">
                <h2 className="flex justify-center items-center text-2xl font-bold">Contact Me To Add New Blog</h2>
