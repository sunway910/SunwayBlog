...
export default function Component() {
    return (
        <div className="flex flex-col gap-10 px-4 py-6">
            <h1 className="text-4xl font-bold">My Favorite Funny Site</h1>
            <div className="grid w-full gap-4">
                <Card>
                    <CardHeader>
                        <CardTitle>云旅游</CardTitle>
                        <CardDescription>看见世界.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Link className="text-blue-500 underline" href="https://www.skylinewebcams.com/">
                            Visit SkyLineWebCams
                        </Link>
                    </CardContent>
                </Card>
            </div>
            <div className="flex flex-col gap-4 w-full max-w-md mx-auto">
                <h2 className="flex justify-center items-center text-2xl font-bold">Contact Me To Add New Funny Site</h2>
