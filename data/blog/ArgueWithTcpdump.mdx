...
> 好久没写技术类型的文章了，一是因为平常工作中踩的小坑不足以输出一篇完整文章；二是因为现在AI能解决很多问题，我不想输出同质化内容；三是因为自己懒。

## Background

AI 时代同质化内容太多，各种 `AI IDE/Agent` 已经能自主完成很多简单工作了，导致很多东西我已经没有写下去的动力了。

但趁着最近比较闲，准备总结一些东西来帮助自己工作中扯皮，内容大概跟 `抓包/tcp-rt/网络等`有关
