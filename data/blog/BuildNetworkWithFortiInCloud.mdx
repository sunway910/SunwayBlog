...
![CreateAliVPC](/static/images/2024-12/BuildNetworkWithFortiInCloud/CreateAliVPC.png)
![AliNetTopology](/static/images/2024-12/BuildNetworkWithFortiInCloud/AliNetTopology.png)
...
![ReduceIPCountReason](/static/images/2024-12/BuildNetworkWithFortiInCloud/ReduceIPCountReason.png)
...
![CreateFortiECS](/static/images/2024-12/BuildNetworkWithFortiInCloud/CreateFortiECS.png)
...
![CreateEIP1](/static/images/2024-12/BuildNetworkWithFortiInCloud/CreateEIP1.png)


**辅助网卡和业务服务器位于同一网段: `10.1.20.xxx` (交换机网段:`10.1.20.0/24`)， 一般选择`10.1.20.252`，辅助网卡的`安全组`和业务服务器共用**

![CreateEIP2](/static/images/2024-12/BuildNetworkWithFortiInCloud/CreateEIP2.png)
...
![ConfigInterface1](/static/images/2024-12/BuildNetworkWithFortiInCloud/ConfigInterface1.png)

![ConfigInterface2](/static/images/2024-12/BuildNetworkWithFortiInCloud/ConfigInterface2.png)


### 2.3 配置 Fortigate Static Routes

![ConfigStaticRoute](/static/images/2024-12/BuildNetworkWithFortiInCloud/ConfigStaticRoute.png)
...
![ConfigFirewallPolicy1](/static/images/2024-12/BuildNetworkWithFortiInCloud/ConfigFirewallPolicy1.png)

**阿里云路由表条目配置如下，该`VPC`下的交换机的下一跳为刚刚创建的辅助网卡，对上 `Fortigate` 上的 `port2(LAN)`**

![ConfigFirewallPolicy2](/static/images/2024-12/BuildNetworkWithFortiInCloud/ConfigFirewallPolicy2.png)
...
![ConfigVirtualIPs](/static/images/2024-12/BuildNetworkWithFortiInCloud/ConfigVirtualIPs.png)

**如上所示，配置`Virtual IPs`规则, 当流量通过 `Fortigate` 公网`ip:port`进来后， 映射(Mapper To)到内网的 `ip:port`**

### 3.2 配置 Fortigate Firewall Policy

![ConfigVirtualIPsRule](/static/images/2024-12/BuildNetworkWithFortiInCloud/ConfigVirtualIPsRule.png)
