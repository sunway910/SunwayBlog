...
- Expose service with Cloudflared
- Nginx whitelist with Cloudflare
- Kubernetes load balance with cloudflare


## 1 Expose service with Cloudflared

My kubernetes cluster has 5 nodes and 1 master, I will expose services in 6 servers in this blog.
```
...
- **7:** Only example for `master` and `node1`, you can add `node2, node3, node4, node5` yaml configuration as below
...
The system architecture can be illustrate as below
