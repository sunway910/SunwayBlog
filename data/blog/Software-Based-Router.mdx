...
![XiaomiRouter4cOpenwrt](/static/images/2024-02/XiaomiRouter4cOpenwrt.png)
...
![SuLinGGOpenwrt](/static/images/2024-02/SuLinGGOpenwrt.png)
...
![OpenWRTIPA](/static/images/2024-02/OpenWRTIPA.png)
...
**日志错误如下图所示**
![SuLinGGLogErr](/static/images/2024-02/SuLinGGLogErr.png)

**功能集成如下图所示**
<center >
    <figure>
        <img  style={{margin: "0 ", display: "inline-block "}} src="/static/images/2024-02/SuLinGGMenu1.png" width="175" />
        <img  style={{margin: "0 ", display: "inline-block "}} src="/static/images/2024-02/SuLinGGMenu2.png" width="175"/>
        <img  style={{margin: "0 ", display: "inline-block "}} src="/static/images/2024-02/SuLinGGMenu3.png" width="175"/>
        <img  style={{margin: "0 ", display: "inline-block "}} src="/static/images/2024-02/SuLinGGMenu4.png" width="175"/>
    </figure>
</center>
...
![RufusClean](/static/images/2024-02/RufusClean.png)
...
![ImmortalWRT2305](/static/images/2024-02/ImmortalWRT2305.png)
...
![OpenClashCoreConfig](/static/images/2024-02/OpenClashCoreConfig.png)

- **步骤4:** 导入自建的 `vmess` 节点
![OpenClashConfig](/static/images/2024-02/OpenClashConfig.png)

- **步骤5:** 启动OpenClash，查看是否启动正常，启动成功后可通过 `http://192.168.2.1:9090` 访问 `OpenClash` 的 `DashBoard` 查看相关配置
![OpenClashDashboard](/static/images/2024-02/OpenClashDashboard.png)
...
![XiaomiWifiIPConfig](/static/images/2024-02/XiaomiWifiIPConfig.png)
